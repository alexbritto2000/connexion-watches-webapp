...
import Buy from "./watch-landing/buy";
  ...
  return (
    <div>
      ...
      <div className="flex justify-between px-6 mt-[-2.5rem]">
        ...
        <div>
          <img
            src="watchLanding/smart-connoisseur.png"
            alt="Smart Connoisseur"
          />
        </div>
      </div>
        ...
        <div className="w-full max-w-7xl flex gap-3 justify-between">
          <Select
            ...
            classNames={{
              base: "bg-white",
              trigger:
                "!border-1 !border-[#E5E7EB] focus-within:!border-black rounded-md flex-nowrap items-center gap-2 text-[0.82rem] bg-white !text-black",
              listbox: "bg-white",
          ...
          >
            <SelectItem
              key="rolex"
              className="bg-white text-black hover:bg-gray-100 data-[selected=true]:text-black"
            >
              Rolex
            </SelectItem>
            <SelectItem
          ...
          >
            <PopoverTrigger>
              <Button
                variant="bordered"
                className="flex-1 bg-white justify-between text-[0.82rem] text-black !border-1 !border-[#E5E7EB] focus:!border-[#000000]"
                radius={"sm"}
              >
          ...
          <Input
            ...
            classNames={{
              inputWrapper:
                "!border-1 !border-[#E5E7EB] focus-within:!border-[#000000] rounded-md text-black bg-white",
            }}
          />

          <div className="bg-black rounded-md px-3 py-1 flex items-center cursor-pointer border-1">
            <img
              src="watchLanding/mdi_camera.svg"
              className="w-6"
              alt="Camera"
            />
          </div>

          <Button type="button" className="text-white bg-black rounded-md">
            Search
          </Button>
        </div>
      </div>

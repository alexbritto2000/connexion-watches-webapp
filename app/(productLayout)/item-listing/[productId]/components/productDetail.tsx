                ...
                <div className="w-[50%]">
                    <div className="flex flex-row items-center justify-between">
                        ...
                        <div className="flex flex-row gap-[0.5rem]">
                            <motion.div
                                className="border border-[#D1D5DB] rounded-[2px] px-[0.9rem] py-[0.8rem] cursor-pointer"
                            >
                                <motion.img
                                    alt="share-icon"
                    ...
                    <div>
                        ...
                        <div className="flex flex-row items-center gap-[6px]">
                            ...
                            <div className="text-[0.9rem] text-[#111928]">
                                below market
                            </div>
                        ...
                        <div className="mt-[1rem] flex flex-row justify-between">
                            <div className="flex">
                                <div className="flex flex-col items-center mr-[1rem]">
                                    <img src="/productDetails/3-stars.svg" alt="stars" className="mb-[-10px]" />

                                    <div className="flex flex-row items-center">
                                        <img src="/productDetails/trust-score-left-bracs.svg" alt="left-bracket" />

                                        <div className="text-[#046C4E] text-[1.875rem] font-medium">
                                            88
                                        </div>

                                        <img src="/productDetails/trust-score-left-bracs.svg" className="transform scale-x-[-1]" alt="right-bracket" />
                                    </div>
                                ...
                                <div className="flex flex-col justify-center">
                                    <div className="flex flex-row items-center gap-[6px]">
                                        ...
                                        <div>
                                            <img src="/productDetails/verified-batch.svg" alt="badge" />
                                        </div>
                            ...
                            <div className="flex flex-row gap-[6px]">
                                ...
                                <div className="flex justify-center items-center border border-[#D1D5DB] rounded-full w-[3.375rem] h-[3.375rem]">
                                    <img src="/productDetails/verified-watch.svg" alt="verified-watch" />
                                </div>

                                <div className="flex justify-center items-center border border-[#D1D5DB] rounded-full w-[3.375rem] h-[3.375rem]">
                                    <img src="/productDetails/watch-graph.svg" alt="watch-graph" />
                                </div>
                            </div>
                        </div>

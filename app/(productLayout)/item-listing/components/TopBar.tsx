      ...
      <div className="flex flex-row justify-between items-center w-full">
        ...
        <div className="flex flex-row items-center gap-[2.5rem]">
          ...
          <div
            ...
            ref={sortDropdownRef}
          >
            <span className="text-[#9CA3AF] text-[0.82rem]">Sort by:</span>
                  ...
                  {sortOptions.map((option) => (
                    <button
                      ...
                      className={`w-full cursor-pointer text-left px-4 py-2 text-sm hover:bg-gray-50 transition-colors ${
                        option === sortBy
                          ? "text-black bg-[#EBF0F2] font-medium"
                          : "text-gray-700"
                      }`}
          ...
          <div className="text-black text-[0.82rem]">
            <span>Showing {currentRange}</span>
      ...
      <div className="flex flex-row items-center mt-[1.25rem] gap-[1rem]">
        ...
        <div className="border border-[#E5E7EB] bg-white rounded-[6px] py-[0.75rem] px-[1rem] gap-[0.5rem] flex flex-row flex-1 items-center justify-between">
          <div className="flex flex-row gap-[0.5rem]">
            <div className="text-black text-[0.82rem]">Selected filters:</div>

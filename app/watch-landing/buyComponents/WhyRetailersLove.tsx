...
const WhyRetailersLove = () => {
  ...
  return (
    <div className="pb-[3.25rem] px-8 bg-[#EBF0F2]">
        ...
        <div className="flex flex-col gap-7">
          ...
          <div className="grid grid-cols-4 lg:grid-cols-2 md:grid-cols-1 gap-3">
            {features.map((feature) => (
              <div
                key={feature.id}
                className="bg-[#FFFFFF] rounded-lg py-[1.5rem] px-[2rem] shadow-md hover:shadow-lg transition-shadow duration-200"
              >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-1 gap-8 mt-16">
          ...
          <div>
            ...
            <div className="bg-white rounded-lg shadow-md h-full flex flex-col justify-between">
              <div>
                <img
                  src="watchLanding/trust-score.png"
                  alt="Trust Score Background"
              ...
              <div className="p-6 pt-0 flex flex-row items-center gap-4">
                <div>
                  <h3 className="text-2xl text-black mb-2">Trust Score</h3>
                  <p className="text-[#111928] text-[0.82rem] leading-relaxed">
                    Trust Score measures user reliability based on transactions,
                    reviews, and verification. A higher score boosts
                    credibility, fostering trust and smoother marketplace
                    interactions.
                  </p>
                </div>
                ...
                <div>
                  <img
                    src="watchLanding/review-stars.svg"
          ...
          <div className="space-y-6 h-full flex flex-col">
            ...
            <div className="shadow-[0px_12px_25px_0px_#0000000D] backdrop-blur-[14.8px] bg-[linear-gradient(0deg,#000,#000),radial-gradient(68.5%_75.95%_at_95%_-30.83%,rgba(255,255,255,0.45)_0%,rgba(255,255,255,0)_100%)] rounded-lg p-6 text-white flex-1">
              <h3 className="text-[1.5rem] mb-[1rem]">Buyer Protection</h3>
              <p className="text-[0.82rem] leading-relaxed mb-[2.5rem]">
                With Buyer Protection, you benefit from secure payments through
                our platform, verified product authenticity, and a legally
                mandated 14-day return policy, ensuring a safe and hassle-free
                shopping experience.
              </p>

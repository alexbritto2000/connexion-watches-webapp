...
const BecomeConnectionCertifier = () => {
  const connectionCertifierBenefits = [
    ...
    },
    {
      ...
      title: "Boost Trust",
      description:
        "Help users make informed decisions with verified connections",
    },
    {
            ...
            <div className="grid grid-cols-[1fr_auto] lg:grid-cols-1">
              ...
              <div className="space-y-6">
                ...
                <div className="p-[4rem] pt-0">
                  ...
                  <p className="text-[0.82rem] text-[#1F2A37] leading-[150%] mb-[2.625rem]">
                    Join our network as a Connection Certifier and play a key
                    role in verifying and ensuring the quality of connections
                    within our marketplace. By certifying connections, you help
                    build trust, improve credibility, and create a more reliable
              ...
              <div className="space-y-6 flex flex-col justify-center pr-[4rem]">
                {connectionCertifierBenefits.map((benefit, index) => (
                  <div
                    className="bg-[#F9FAFB] border border-gray-200 rounded-xl py-[2.125rem] px-[2rem] flex flex-row items-center max-w-[30.625rem]"
                    key={index}
                  >
